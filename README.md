...
|------|----------------|
| ![Cart](docs/screenshots/cart.png) <br> `docs/screenshots/cart.png` | ![Payment Success](docs/screenshots/payment_success.png) <br> `docs/screenshots/payment_success.png` |
