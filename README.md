...
|----------------|-------------|-------|
| ![Product Detail](docs/screenshots/product_detail.png) | ![Chat Widget](docs/screenshots/agent_chat.png) | <img src="docs/screenshots/admin.png" alt="Admin" height="360"> |
