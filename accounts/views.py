...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            #Create user profile automatically if he registers
            profile = UserProfile()
            ...
            mail_subject = 'Activation link for your PLANTAE account'
            ...
            send_email.send()
            # messages.success(request, 'An activation link has been sent to your mail to verify your account.')
        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exist:
                    ...
                    # let product_variation = [1, 2, 3, 4, 6]
                    # and ex_var_list=[4, 6, 3, 5]
                    # now we have to check common in both list
            ...
            # messsages.success(request, 'You are now logged in.')
...
def forgotPassword(request):
    if request.method == 'POST':
        ...
        if Account.objects.filter(email = email).exists():
            ...
            #RESET Password
            current_site = get_current_site(request)
            mail_subject = "Reset your PLANTAE account's passwords"
    ...
    if request.method == 'POST':
        ...
        if new_password == confirm_password:
            ...
            if success:
                ...
                user.save()
                # to log out the user after resetting password
                # auth.logout(request)
